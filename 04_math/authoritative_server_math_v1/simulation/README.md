...
The script loads planning configs from `../simulation_config_refinement`, generates deterministic pseudo-rounds, and writes a sample report with feature contribution, cap frequency, win-tier distribution, and one deterministic replay payload.
