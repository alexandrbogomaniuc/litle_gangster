# 8001 VABS Legacy Alias Apply Blockers
...
The alias foundation exists for local planning/testing only. BO/CM compatibility cannot
be claimed until targeted BO/CM or equivalent acceptance tests pass. Durable history
storage remains unproven, so fixture-backed alias rendering is not release-ready.
