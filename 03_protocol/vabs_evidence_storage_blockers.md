# VABS Evidence Storage Blockers
...
The policy supports screenshot and video modes, but no capture or durable storage was
implemented. Media settings must remain planning-only until a future implementation
sprint explicitly approves storage/capture work.
