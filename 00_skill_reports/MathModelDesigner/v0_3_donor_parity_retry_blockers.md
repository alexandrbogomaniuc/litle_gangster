# MathModelDesigner v0.3 Donor-Parity Retry Blockers
...
- `golden_square_exact_persistence_unverified`
- `rainbow_activation_exact_behavior_unverified`
- `coin_reveal_values_probabilities_unverified`
...
GameClientBuilder remains blocked. GameServerRegistrar remains blocked. Release remains blocked.
